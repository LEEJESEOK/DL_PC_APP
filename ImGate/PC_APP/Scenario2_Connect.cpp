#include "pch.h"
#include "Scenario2_Connect.h"
#if __has_include("Scenario2_Connect.g.cpp")
#include "Scenario2_Connect.g.cpp"
#endif
...
#pragma region UI Code
	Scenario2_Connect::Scenario2_Connect()
	{
		InitializeComponent();
	}

	void Scenario2_Connect::OnNavigatedTo(NavigationEventArgs const&)
	{
	...
	fire_and_forget Scenario2_Connect::OnNavigatedFrom(NavigationEventArgs const&)
	{
...
#pragma region Enumerating Services
	IAsyncOperation<bool> Scenario2_Connect::ClearBluetoothLEDeviceAsync()
	{
		auto lifetime = get_strong();
...
#pragma endregion
	...
	void Scenario2_Connect::AddValueChangedHandler()
	{
	...
	void Scenario2_Connect::RemoveValueChangedHandler()
	{
	...
	fire_and_forget Scenario2_Connect::CharacteristicList_SelectionChanged()
	{
		auto lifetime = get_strong();
	...
	void Scenario2_Connect::EnableCharacteristicPanels(GattCharacteristicProperties properties)
	{
	...
	fire_and_forget Scenario2_Connect::CharacteristicReadButton_Click()
	{
		auto lifetime = get_strong();
	...
	fire_and_forget Scenario2_Connect::CharacteristicWriteButton_Click()
	{
		auto lifetime = get_strong();
	...
	fire_and_forget Scenario2_Connect::CharacteristicWriteButtonInt_Click()
	{
		auto lifetime = get_strong();
	...
	IAsyncOperation<bool> Scenario2_Connect::WriteBufferToSelectedCharacteristicAsync(IBuffer buffer)
	{
		auto lifetime = get_strong();
	...
	hstring Scenario2_Connect::FormatValueByPresentation(IBuffer const& buffer, GenericAttributeProfile::GattPresentationFormat const& format)
	{
